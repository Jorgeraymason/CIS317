...
public class InheritanceTest
{
    ...
    {
        //Replace "Devin Avery" with your first and last name
        Console.WriteLine("\nDevin Avery – SDC320 GP - Inheritance");
        Console.WriteLine("--------------------------------------");
        ...
        CollegeStudent cs = new CollegeStudent("Devin Avery", "ECPI University",
        "Computer Science");
        ...
        //console
        UndergraduateStudent us = new UndergraduateStudent("Devin Avery",
